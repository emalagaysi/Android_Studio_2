package com.example.android_2bmi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        height = (EditText)findViewById(R.id.high1);                           // 取得身高物件
        weight = (EditText)findViewById(R.id.Weight1);                           // 取得體重物件
        Button submit = (Button)findViewById(R.id.out); // 取得按鈕物件 如果ID有誤請回到res->Layout查看預設Button是多少
        ...
        submit.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                        ...
                        || "".equals(weight.getText().toString())) )
                {
                    ...
                    TextView dia = (TextView)findViewById(R.id.DIA1);// 取得 顯示診斷 物件
